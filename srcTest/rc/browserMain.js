...
(function () {
  ...
  require.config({
    ...
    paths: {
      ...
      nmodule: '/module',
      'nmodule/jsTest': 'build/karma/src',
      'nmodule/jsTestTest': 'build/karma/srcTest',
  ...
  define('nmodule/jsTest/rc/jsTest.built.min');
  ...
  require([ 'niagara-test-server/karmaUtils',
    ...
    karmaUtils.setupAndRunSpecs({
      user: 'admin',
      pass: 'asdf1234',
      specs: [ 'nmodule/jsTestTest/rc/spec/allSpecs' ]
    }, function (err) {
